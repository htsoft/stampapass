...
class InsertGuestAction extends GuestAction
{
    /**
     * {@inheritdoc}
     */
    protected function action(): Response
    {
        ...
        $this->logger->info("Richiesto l'inserimento di un nuovo ospite con badge: " . $data->badge);
        $obj = new Guest(0, $data->cognome, $data->nome, $data->badge, $data->status, '');
        $dato = $this->repository->insert($obj);
